...
from utils import get_candidates, format_candidates, get_candidates_by_id, get_candidates_by_skill
...
def page_candidate(candidate_id):
    ...
    candidate = get_candidates_by_id(candidates_list, candidate_id)
